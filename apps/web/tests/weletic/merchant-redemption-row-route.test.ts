...
import { POST } from "../../app/api/internal/shopify/merchant/analytics/redemption-rows/route";
...
vi.mock("../../lib/weletic/shopify/merchant-redemption-row-export", () => ({
  readShopifyMerchantRedemptionRowExportInTransaction: mocks.query,
}));
...
const request = (body: unknown) =>
  new Request(
    "https://backend.example/api/internal/shopify/merchant/analytics/redemption-rows",
    {
      method: "POST",
