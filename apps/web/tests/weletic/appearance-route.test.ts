...
import { POST } from "../../app/api/internal/shopify/merchant/loyalty-appearance/route";
...
vi.mock("../../lib/weletic/shopify/loyalty-appearance", () => ({
  manageShopifyLoyaltyAppearanceInTransaction: mocks.manage,
}));
const secret = "synthetic-appearance-route-secret-not-a-credential";
const path = "/api/internal/shopify/merchant/loyalty-appearance";
const actor = {
  version: 1,
  appId: "fixture-app",
...
it.each([
  ...
  [new LoyaltyAppearanceConflictError(), 409, "state_changed"],
  [new Error("private database detail"), 503, "appearance_unavailable"],
])(
