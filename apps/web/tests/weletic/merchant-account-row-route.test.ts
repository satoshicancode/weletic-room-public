...
import { POST } from "../../app/api/internal/shopify/merchant/analytics/account-rows/route";
...
vi.mock("../../lib/weletic/shopify/merchant-account-row-export", () => ({
  readShopifyMerchantAccountRowExportInTransaction: mocks.query,
}));
...
const request = (body: unknown) =>
  new Request(
    "https://backend.example/api/internal/shopify/merchant/analytics/account-rows",
    {
      method: "POST",
