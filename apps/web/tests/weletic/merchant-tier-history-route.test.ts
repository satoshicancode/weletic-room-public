...
import { POST } from "../../app/api/internal/shopify/merchant/analytics/tier-history/route";
...
vi.mock("../../lib/weletic/shopify/merchant-tier-history-export", () => ({
  readShopifyMerchantTierHistoryExportInTransaction: mocks.query,
}));
...
const request = (body: unknown) =>
  new Request(
    "https://backend.example/api/internal/shopify/merchant/analytics/tier-history",
    {
      method: "POST",
