...
export const DraftControls = forwardRef<
  DraftControlsHandle,
  DraftControlsProps
>(function DraftControls({ props, workspaceId }: DraftControlsProps, ref) {
  ...
  useEffect(() => {
    ...
    return () => unsubscribe();
  }, [watch, isDirty, getValues, saveDraftDebounced]);
  ...
  useImperativeHandle(
    ...
    [removeDraft, sessionId, getValues, isDirty, saveDraft],
  );
