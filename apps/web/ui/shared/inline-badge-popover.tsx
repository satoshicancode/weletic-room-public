...
>(function InlineBadgePopoverInput(
  { maxLength, className, ...rest }: HTMLProps<HTMLInputElement>,
  ref,
) {
  ...
  return (
    ...
    >
      <input
        ref={ref}
        className={cn(
          "w-full rounded-md border-none px-2.5 py-1.5 text-sm text-neutral-900 focus:outline-none focus:ring-0",
          maxLength && "pr-4",
        )}
        onKeyDown={(e) => {
...
InlineBadgePopoverInput.displayName = "InlineBadgePopoverInput";
...
>(function InlineBadgePopoverAmountInput(
  { type, className, onKeyDown, onChange, ...rest },
  ref,
) {
  const { setIsOpen } = useContext(InlineBadgePopoverContext);
...
InlineBadgePopoverAmountInput.displayName = "InlineBadgePopoverAmountInput";
