...
>(function PartnerPlatformsForm(
  ...
  const { executeAsync } = useAction(updatePartnerPlatformsAction, {
    onSuccess: async () => {
      toast.success("Successfully updated your websites and social accounts.");
...
PartnerPlatformsForm.displayName = "PartnerPlatformsForm";
