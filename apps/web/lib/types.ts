...
import { PartnerReferral } from "./partner-referrals/types";
...
export interface WorkspaceProps
  ...
  users: {
    ...
    workspacePreferences?: Prisma.JsonValue | null;
  }[];
  flags?: {
...
export type EnrolledPartnerCompositeProps = EnrolledPartnerExtendedProps & {
  group?: GroupWithProgramProps | null;
  discountCodes?: DiscountCodeProps[];
  referral?: PartnerReferral | null;
  eligibleBounties?: BountyListProps[];
