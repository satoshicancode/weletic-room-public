...
import { loyaltyNudgeRequestSchema } from "@/lib/weletic/loyalty/nudge-contract";
...
const bodySchema = z
  .object({
    ...
    request: loyaltyNudgeRequestSchema,
  })
  .strict();
