...
import { merchantReviewIncentiveReadInputSchema } from "@/lib/weletic/reviews/incentive-merchant-contract";
import { readShopifyMerchantReviewIncentivesInTransaction } from "@/lib/weletic/shopify/merchant-review-incentive-read";
import {
...
const schema = z
  .object({
    ...
    input: merchantReviewIncentiveReadInputSchema,
  })
  .strict();
  ...
  try {
    ...
    return reply(
      await prisma.$transaction((tx) =>
        readShopifyMerchantReviewIncentivesInTransaction({
          tx,
