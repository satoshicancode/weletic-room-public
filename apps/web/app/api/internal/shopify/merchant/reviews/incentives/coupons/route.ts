...
import { merchantReviewCouponListInputSchema } from "@/lib/weletic/reviews/incentive-merchant-contract";
import { listShopifyMerchantReviewCouponsInTransaction } from "@/lib/weletic/shopify/merchant-review-coupons";
import {
...
const schema = z
  .object({
    ...
    input: merchantReviewCouponListInputSchema,
  })
  .strict();
  ...
  try {
    ...
    return reply(
      await prisma.$transaction((tx) =>
        listShopifyMerchantReviewCouponsInTransaction({
          tx,
