...
import { merchantLedgerRowExportRequestSchema } from "@/lib/weletic/loyalty/ledger-row-export-contract";
...
const bodySchema = z
  .object({
    ...
    request: merchantLedgerRowExportRequestSchema,
  })
  .strict();
...
export async function POST(request: Request) {
  try {
    ...
    return reply({ error: "ledger_rows_unavailable" }, 503);
  }
}
