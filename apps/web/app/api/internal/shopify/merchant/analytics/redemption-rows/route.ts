...
import { merchantRedemptionRowExportRequestSchema } from "@/lib/weletic/loyalty/redemption-row-export-contract";
...
const bodySchema = z
  .object({
    ...
    request: merchantRedemptionRowExportRequestSchema,
  })
  .strict();
...
export async function POST(request: Request) {
  try {
    ...
    return reply({ error: "redemption_rows_unavailable" }, 503);
  }
}
