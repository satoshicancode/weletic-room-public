...
import { merchantAccountRowExportRequestSchema } from "@/lib/weletic/loyalty/account-row-export-contract";
...
const bodySchema = z
  .object({
    ...
    request: merchantAccountRowExportRequestSchema,
  })
  .strict();
...
export async function POST(request: Request) {
  try {
    ...
    return reply({ error: "account_rows_unavailable" }, 503);
  }
}
