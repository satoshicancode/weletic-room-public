...
import { Button, Check2, useTranslations } from "@dub/ui";
    ...
    <div className="border-border-subtle divide-border-subtle flex flex-col divide-y rounded-lg border">
      <div className="px-6 py-8">
        <h3 className="text-content-emphasis text-lg font-semibold leading-7">
          {t("profile.howYouWorkTitle") || "How you work"}
        </h3>
        <p className="text-content-subtle text-sm font-normal leading-5">
          {t("profile.howYouWorkDesc") ||
      ...
      >
        <SettingsRow
          ...
          heading={
            t("profile.preferredEarningHeading") ||
            "Preferred earning structure"
          }
          description={
            t("profile.preferredEarningDesc") ||
        ...
        <SettingsRow
          id="channels"
          heading={t("profile.salesChannelsHeading") || "Sales channels"}
          description={
            t("profile.salesChannelsDesc") ||
