...
export function ProfileDetailsForm({
  ...
  return (
    <div className="border-border-subtle divide-border-subtle flex flex-col divide-y rounded-lg border">
      ...
      <SettingsRow
        id="info"
        heading={t("profile.basicInfoHeading") || "Basic information"}
        description={
      ...
      {["approved", "trusted"].includes(partner?.networkStatus ?? "") && (
        <SettingsRow
          ...
          heading={
            t("profile.identityVerificationHeading") || "Identity verification"
          }
          description={
      ...
      <SettingsRow
        id="platforms"
        heading={
          t("profile.websitesAndSocialsHeading") || "Website and socials"
        }
        description={
          t("profile.websitesAndSocialsDesc") ||
    ...
    <>
      ...
      >
        <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="mt-1.5 text-xs text-neutral-500">
                  {t("profile.recommendedAvatarSize") ||
          ...
          <label className="flex flex-col gap-1.5">
            <span className="text-sm font-medium text-neutral-800">
              {t("profile.profileType") || "Profile type"}
            </span>
            <DynamicTooltipWrapper
              tooltipProps={{
                content: disabled
                ...
                <div className="w-full">
                  <ToggleGroup
                    options={[
                      {
                        value: "individual",
                        label: t("profile.individual") || "Individual",
                      },
                      {
                        value: "company",
          ...
          <AnimatePresence mode="popLayout">
            {profileType === "company" && (
              ...
              >
                <label className="flex flex-col gap-1.5">
                  <span className="text-sm font-medium text-neutral-800">
                    {t("profile.legalCompanyName") || "Legal company name"}
                  </span>
                  <div>
                    <input
                      type="text"
