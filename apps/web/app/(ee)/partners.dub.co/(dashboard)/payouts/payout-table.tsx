...
export function PayoutTable() {
  ...
  const table = useTable({
    ...
    columns: [
      {
        id: "periodEnd",
        header: t("payouts.period") || "Period",
        accessorFn: (d) => formatPeriod(d),
      },
      {
        header: t("payouts.program") || "Program",
        cell: ({ row }) => (
      ...
      {
        id: "initiatedAt",
        header: t("payouts.initiated") || "Initiated",
        meta: {
          headerTooltip:
      ...
      {
        id: "amount",
        header: t("payouts.amount") || "Amount",
        cell: ({ row }) => (
          <div className="flex items-center gap-2">
            ...
            {row.original.mode === "internal" &&
              INVOICE_AVAILABLE_PAYOUT_STATUSES.includes(
                ...
                <Tooltip content={t("payouts.viewInvoice") || "View invoice"}>
    ...
    <>
      ...
      <div className="flex flex-col gap-4">
        ...
        {payouts?.length !== 0 ? (
          ...
          <AnimatedEmptyState
            title={t("payouts.noPayouts") || "No payouts found"}
            description={
