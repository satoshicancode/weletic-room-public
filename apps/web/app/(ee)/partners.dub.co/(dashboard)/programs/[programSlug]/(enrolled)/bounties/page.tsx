...
export default function PartnerProgramBountiesPage() {
  ...
  const tabs = [
    {
      label: t("bounties.active") || "Active",
      id: "active" as const,
    },
    {
      label: t("bounties.expired") || "Expired",
      id: "expired" as const,
    },
  ];
  ...
  return (
    <PageContent title={t("navigation.bounties") || "Bounties"}>
      <PageWidthWrapper className="pb-10">
        ...
        {filteredBounties?.length !== 0 || isLoading ? (
          ...
          <AnimatedEmptyState
            title={t("bounties.noBounties") || "No bounties found"}
            description={
              t("bounties.noBountiesDescription") ||
