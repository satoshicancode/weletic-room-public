...
export interface UsePartnerFiltersOptions {
  deferOptionFetches?: boolean;
}
...
export function usePartnerFilters(
  ...
  options: UsePartnerFiltersOptions = {},
) {
  ...
  const { deferOptionFetches = false } = options;
  ...
  const shouldFetchOptions = useCallback(
    (key: PartnerFilterKey) =>
      ...
      (!deferOptionFetches ||
        selectedFilter === key ||
        Boolean(searchParamsObj[key])),
    [deferOptionFetches, enabledFilters, searchParamsObj, selectedFilter],
  );

  const { partnerTags, partnerTagsAsync } = usePartnerTagFilterOptions({
    search: selectedFilter === "partnerTagId" ? debouncedSearch : "",
    enabled: shouldFetchOptions("partnerTagId"),
    status,
    cohortParams,
  });
  ...
  >({
    ...
    status,
    ...cohortParams,
    enabled: shouldFetchOptions("country"),
  });
  ...
  >({
    ...
    status,
    ...cohortParams,
    enabled: shouldFetchOptions("status"),
  });
  ...
  >({
    ...
    status,
    ...cohortParams,
    enabled: shouldFetchOptions("groupId"),
  });
  ...
  >({
    ...
    status,
    ...cohortParams,
    enabled: shouldFetchOptions("referredByPartnerId"),
  });
