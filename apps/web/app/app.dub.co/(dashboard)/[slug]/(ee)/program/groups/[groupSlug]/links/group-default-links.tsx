  ...
  const { setShowConfirmModal, confirmModal } = useConfirmModal({
    ...
    description: (
      <>
        ...
        <br />
        <br />
        This won&apos;t affect any existing partner links that have traffic on
        them, but if you recreate the link, it could result in duplicate links
        for partners in this group.
        <br />
        <br />
