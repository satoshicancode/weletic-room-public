...
Updated September 24 from public main `b8371bae` (S26 status merged) and this
S27 change. **Analytics is not accepted live.** The report dispositions distinguish
...
| S27 | Total members over time                       | **Candidate / partial.** [Retained account enrollments](retained-enrollment-series-s27-2026-09-24.md) count current retained accounts by enrollment month and exact cumulative total. Erasure and unavailable history prevent historical active-membership reconstruction; provider and installed acceptance remain open. A05. |
