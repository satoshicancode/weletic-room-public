...
- [Merchant contract](../../apps/web/lib/weletic/loyalty/merchant-analytics-contract.ts):
  ...
  ranking, S27 partial retained-account enrollments and S22 partial retained
  reward-debit cohorts are merged. There are no sequential
...
- [S15 tier-event export implementation](../../apps/web/lib/weletic/shopify/merchant-tier-history-export.ts):
  a separate signed, audited owner-only row path with strict UTC range, a
  single-transaction 2,000-row cap, installation fencing and pseudonymous
...
- [S01 merged current-account row export](../../apps/web/lib/weletic/shopify/merchant-account-row-export.ts):
  ...
  [enrollment index](account-enrollment-index-preflight-2026-09-25.md) is merged
  but unapplied on shared targets; provider-scale and installed acceptance remain
  open.
- [S10 merged redemption-row export](https://github.com/satoshicancode/weletic-room-public/pull/143):
  ...
  [Isolated SQL evidence](recorded-redemption-rows-s10-2026-09-25.md) exists;
  transition history, provider-scale and installed acceptance remain open.
...
| S02 | List of customers by VIP tier                 | **Merged current snapshot / partial.** The S01 owner-only CSV has pseudonymous current account rows with tier order and enrollment date; owners can group retained rows by current tier within the enrollment window. Tier-entry dates, next-tier deltas, historical membership and reference columns remain unavailable. Redacted accounts are excluded; the 2,000-row cap and installed acceptance remain open. A01, A05.                                                     |
...
| S15 | List of VIP tier changes                      | **Implementation candidate / partial.** A separate owner-only pseudonymous tier-event CSV has a bounded signed path and isolated SQL cap/concurrent-redaction evidence. Provider-scale read plan and installed acceptance remain open. Current tier labels do not reconstruct historical names or membership. A01, A05.                                                                                                                                                         |
...
| S26 | Top ways to redeem                            | **Merged implementation / partial.** [Recorded redemption debits](recorded-redemption-sources-s26-2026-09-24.md) rank captured reward debit groups by exact points and entry counts, with explicit unknown and overflow totals. Remote discount use, missing history and the reference Total formula remain unavailable. A04.                                                                                                                                                   |
| S27 | Total members over time                       | **Merged implementation / partial.** [Retained account enrollments](retained-enrollment-series-s27-2026-09-24.md) count current retained accounts by enrollment month and exact cumulative total. Erasure and unavailable history prevent historical active-membership reconstruction; provider and installed acceptance remain open. A05.                                                                                                                                      |
...
| S33 | VIP tier changes over time                    | **Candidate / partial.** [Recorded tier-change reasons](recorded-tier-change-reasons-s33-2026-09-24.md) count retained events by stored reason in UTC months. Reasons do not prove historical direction or tier membership; added/promoted/demoted/removed members remain unavailable. Installed acceptance is open. A05.                                                                                                                                                       |
...
partial merged captured-debit ranking; full reward-revision economics remain open.
