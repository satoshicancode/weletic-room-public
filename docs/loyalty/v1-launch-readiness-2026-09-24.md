...
| L09 | Analytics/exports           | implemented; incomplete                      | [Report inventory](analytics-report-coverage.md); [S23 ledger net](recorded-ledger-net-s23-2026-09-24.md) and [S21 first recorded earns](first-recorded-earners-s21-2026-09-24.md) merged; [S33 recorded tier reasons](recorded-tier-change-reasons-s33-2026-09-24.md) is a local candidate; shared indexes unapplied                                    | S18, lifetime cohorts, historical VIP membership, historical liability, private exports, installed reconciliation and shared index gates | M2        |
