...
| L02 | Rewards/wallet              | Fixed discount live subset; [local boundaries](financial-reward-boundaries-2026-09-16.md) and [isolated SQL increment](reward-sql-acceptance-2026-09-24.md) | Every enabled reward lifecycle and remote cleanup                   | M2        |
