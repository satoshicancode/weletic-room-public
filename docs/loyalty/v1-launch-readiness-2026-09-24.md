...
An [unpublished refund allocation audit draft](refund-allocation-audit-2026-09-25.md)
...
| Loyalty refund allocation table                                                 | [Unpublished draft](refund-allocation-audit-2026-09-25.md); disposable MySQL only                                                 | Exact target metadata, compatible query plan and separate shared-migration approval before refund writers or reconciliation readers; retain rows during binary rollback                                                |
