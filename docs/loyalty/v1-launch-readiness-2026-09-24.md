...
passed all applicable checks, including Shopify checks. Deployed acceptance
remains open.
...
| L10 | Historical imports          | locally verified at 50,000 rows              | [Strict 50,000-row isolated lifecycle](historical-import-rollback-group-2026-09-24.md); [prior failed attempts](historical-import-scale-attempt-2026-09-24.md); [proof-reader joins](https://github.com/satoshicancode/weletic-room-public/pull/122); [current enum preflight](https://github.com/satoshicancode/weletic-room-public/pull/110)                                                                                                                                                                                                                                                                                                                                                                                                                    | Full-scale process restart, provider read plans and exact-target schema, installed reconciliation                                                                                                                                         | M2        |
...
An [unmerged refund allocation audit draft](https://github.com/satoshicancode/weletic-room-public/pull/173)
adds immutable line rows and an exact final source-line target check. Thirty
disposable MySQL tests passed, including privacy-minimized refunds. This work
is not shipped: its additive table, exact-target Vitess query compatibility,
legacy-history disposition and installed financial reconciliation remain gated.
...
| Loyalty refund allocation table                                                 | [Unmerged draft PR #173](refund-allocation-audit-2026-09-25.md); disposable MySQL only                                            | Exact target metadata, compatible query plan and separate shared-migration approval before refund writers or reconciliation readers; retain rows during binary rollback                                                |
